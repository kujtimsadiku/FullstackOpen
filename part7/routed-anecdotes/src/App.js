...
const Anecdote = (props) => {
  ...
  ? props.anecdoteById(Number(match.params.id))
  : null
  ...
  return (
    <div>
      ...
      <div style={paddingBottom}>
          has more info see <Link to={anecdote.info}>{anecdote.info}</Link>
      </div>
    </div>
  );
}
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Routes>
        <Route path='/' element={<Menu anecdotes={anecdotes} notification={notification}/>} />
